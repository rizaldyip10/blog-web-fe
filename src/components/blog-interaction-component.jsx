...
const BlogInteraction = () => {
    ...
    let { blog, blog: { _id, title, blog_id, activity, activity: { total_likes, total_comments }, author: { personal_info: { username: author_username } } }, setBlog, isLikedByUser, setLikedByUser, setCommentWrapper } = useContext(BlogContext)
            ...
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-6 items-center">
                    ...
                    <Link to={`https://twitter.com/intent/tweet?text=Read${title}&url${location.href}`}>
                        <i className="fi fi-brands-twitter-alt-circle text-xl hover:text-twitter"></i>
                    </Link>
                </div>
            </div>
