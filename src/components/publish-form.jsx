...
const PublishForm = () => {
    ...
    const handleKeyDown = (e) => {
        if (e.keyCode == 13 || e.keyCode == 188) {
            ...
            if (tags.length < tagLimit) {
                ...
                toast.error(`You only can add tag up to ${tagLimit} tags`)
            }
    ...
    const publishBlog = (e) => {
        ...
        if(!des.length || des.length > characterLimit) {
            return toast.error(`Please enter blog description of your blog less than ${characterLimit} characters`)
        }
        if (!tags.length) {
            return toast.error("Please enter at least 1 tag to help us rank your blog")
        }
