...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let { seen, type, reply, createdAt, comment, replied_on_comment, user, user: { personal_info: { profile_img, fullname, username } }, blog: { _id, blog_id, title }, _id: notification_id } = data
...

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    <div className="flex gap-3 mb-3">
                        ...
                        <div>
                            <h1 className="font-medium text-xl text-dark-grey">
                                <Link to={`/user/${author_username}`} className="mx-1 text-black">
                                    You
                                </Link>
