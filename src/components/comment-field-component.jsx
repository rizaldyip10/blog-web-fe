...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
    ...
    const handleComment = () => {
        if (!access_token) {
            return toast.error("You have to login to comment")
        }
        if (!comment.length) {
        ...
        .then(({ data }) => {
            ...
            let parentCommentIncreamentVal = replyingTo ? 0 : 1
            ...
            setBlog({
                ...
                activity: { 
                    ...
                    total_parent_comments: total_parent_comments + parentCommentIncreamentVal 
                } 
            })
