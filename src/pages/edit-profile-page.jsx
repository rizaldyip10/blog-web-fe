...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (bio.length > bioLimit) {
            return toast.error(`Your bio should not be more than ${bioLimit}`)
        }
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="w-full">
                            ...
                            <p className="my-6 text-dark-grey">Add your social media below</p>
                                    ...
                                    Object.keys(social_links).map((key, i) => {
                                        ...
                                        return (
                                            <InputBox
                                                ...
                                                value={link}
                                                placeholder="https://"
                                                icon={"fi " + (key == "website" ? "fi-rr-globe" : `fi-brands-${key}`)}
                                            />
                                        )
                                    })
                                }
